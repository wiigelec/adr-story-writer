...
FS-004 requirements are inactive during Planning. Build shall activate them only
when the corresponding implementation and mechanically required evaluation
